...
class server(tk.Frame, control, version, psql):
    ...
    def __init__(self, master):
        ...
        self.dir_path = tk.Button(self, text="odoo", command=lambda: self.get_path_window(), font=font.Font(size=7), **self.style_small_btn)
    ...
    def place_all(self):
        ...
        self.dir_path.place(x=3, y=47, height=20, width=35)
